...
public class KafkaProducerMessageHandler extends AbstractMessageHandler {
	...
	protected void handleMessageInternal(final Message<?> message) throws Exception {
		String topic = this.topicExpression != null ?
				...
				: (enableHeaderRouting ? message.getHeaders().get(KafkaHeaders.TOPIC, String.class) : null);
		...
		Integer partitionId = this.partitionIdExpression != null ?
				...
				: (enableHeaderRouting ? message.getHeaders().get(KafkaHeaders.PARTITION_ID, Integer.class) : null);

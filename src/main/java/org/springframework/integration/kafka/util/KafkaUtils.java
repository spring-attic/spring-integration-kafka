...
public class KafkaUtils {
	 ...
	 * @return {@link TopicMetadata} information for the topic
	 */
	public static TopicMetadata ensureTopicCreated(final ZkClient zkClient, final String topicName, final int numPartitions,
			Properties topicConfig, Map<Object, Seq<Object>> replicaAssignment) {

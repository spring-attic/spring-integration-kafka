...
public class KafkaOffsetManagerTests extends AbstractOffsetManagerTests {
	...
	@Override
	protected OffsetManager createOffsetManager(long referenceTimestamp, String consumerId, Map<Partition, Long> initialOffsets) throws Exception {
		KafkaTopicOffsetManager kafkaTopicOffsetManager = new KafkaTopicOffsetManager(new ZookeeperConnect(kafkaRule.getZookeeperConnectionString()),

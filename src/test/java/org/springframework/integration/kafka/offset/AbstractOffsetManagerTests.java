...
public abstract class AbstractOffsetManagerTests {
	...
	public void testFailureWhenPartitionDoesNotExist() throws Exception {
		OffsetManager offsetManager = createOffsetManager(OffsetRequest.EarliestTime(), "offset", null);
	...
	public void testInitialization() throws Exception {
		...
		OffsetManager offsetManager2 = createOffsetManager(OffsetRequest.EarliestTime(), "offset2", null);
		...
		OffsetManager offsetManager3 = createOffsetManager(OffsetRequest.LatestTime(), "offset3", null);
	...
	public void testUpdate() throws Exception {
		...
		OffsetManager newOffsetManager1 = createOffsetManager(OffsetRequest.EarliestTime(), "offset1", null);
	...
	public void testRemove() throws Exception {
		...
		// a new offset manager with a different consumerId will not observe the updates
		OffsetManager offsetManager2 = createOffsetManager(OffsetRequest.LatestTime(), "offset2", null);
	...
	public void testInitialOffsets() throws Exception {
		...
		// a new offset manager with the same consumerId will observe the updates
		OffsetManager newOffsetManager2 = createOffsetManager(OffsetRequest.EarliestTime(), "offset1", null);
	...
	protected abstract OffsetManager createOffsetManager(long referenceTimestamp, String consumerId, Map<Partition, Long> initialOffsets) throws Exception;
}

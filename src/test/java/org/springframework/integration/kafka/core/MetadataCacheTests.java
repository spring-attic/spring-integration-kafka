...
public class MetadataCacheTests {
	...
	public void testMetadataCacheMergedWithOverride() throws Exception {
		...
		overridingPartitionsMetadatas.$plus$eq(new PartitionMetadata(0, asScalaOption(new Broker(0, "host10", 2000)), emptySeq(),
				emptySeq(), ErrorMapping.NoError()));
		overridingPartitionsMetadatas.$plus$eq(new PartitionMetadata(1, asScalaOption(new Broker(0, "host11", 2001)), emptySeq(),
				emptySeq(), ErrorMapping.NoError()));
		overridingPartitionsMetadatas.$plus$eq(new PartitionMetadata(2, asScalaOption(new Broker(0, "host12", 2002)), emptySeq(),
				emptySeq(), ErrorMapping.NoError()));
		overridingPartitionsMetadatas.$plus$eq(new PartitionMetadata(3, asScalaOption(new Broker(0, "host13", 2003)), emptySeq(),
				emptySeq(), ErrorMapping.NoError()));
